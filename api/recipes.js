...
5. USE THEIR INGREDIENTS: build each recipe around the ingredients provided. You may assume basic staples are always available (salt, water, cooking oil, sugar, and everyday Indian spices like turmeric, mustard seeds and curry leaves). Put the user's own ingredients that a recipe uses in "ingredientsHave". Anything else the recipe needs goes in "ingredientsNeeded" — keep that short (a few items max).
